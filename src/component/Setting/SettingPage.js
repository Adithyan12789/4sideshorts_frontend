              ...
              {/* <div className="col-6">
                                <div className="mb-4">
                                    <div className="withdrawal-box payment-box">
                                        <h6>Free News For Non Vip</h6>
                                        <div className="row">
                                            <div className="row">
                                                <div className="col-12 withdrawal-input border-setting">
                                                    <Input
                                                        // label={"Free News For Non Vip"}
                                                        name={"freeNewsForNonVip"}
                                                        type={"text"}
                                                        value={freeNewsForNonVip || ""}
                                                        placeholder={""}
                                                        onChange={(e) => {
                                                            setFreeNewsForNonVip(e.target.value);
                                                        }}
                                                    />
                                                </div>
                                            </div>
                      ...
                      <div className="row">
                        <div className="col-12 withdrawal-input border-setting">
                          <Input
                            ...
                            type={'text'}
                            value={freeNewsForNonVip || ''}
                            placeholder={`Enter Free News Limit`}
                            onChange={(e) => {
                              setFreeNewsForNonVip(e.target.value);
                            }}
                          />
