...
import NewsChannelListDialogue from "../component/newsChannelList/NewsChannelListDialogue";
...
const newsChannelList = () => {
  ...
  const { newsChannelsList, totalUser } = useSelector((state) => state.newsChannelsList);
...
newsChannelList.getLayout = function getLayout(page) {
